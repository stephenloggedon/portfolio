defmodule PortfolioWeb.HomeLive do
  ...
  def render(assigns) do
    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-white">
      ...
      <div class="fixed bottom-8 flex gap-6">
        <a
          href="https://github.com/stephenloggedon"
          target="_blank"
          rel="noopener noreferrer"
          class="text-gray-900 p-2 transition-colors visited:text-gray-900 relative group"
          title="GitHub"
        >
        ...
        <a
          href="https://linkedin.com/in/smfbrooks"
          target="_blank"
          rel="noopener noreferrer"
          class="text-gray-900 p-2 transition-colors visited:text-gray-900 relative group"
          title="LinkedIn"
